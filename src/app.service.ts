    ...
    public getAllEndpoints() {
        return {
            ...
            auth: {
                ...
                '[Auth API] Redeem token                    ':
                    'POST ' + this.baseUrl + '/auth/token header [Bearer authorization]',
            ...
            user: {
                ...
                '[User API] GET users                       ':
                    'GET  ' + this.baseUrl + '/user?offset={offset}&limit={limit}',
            },
            comment: {
                '[comment  API] POST one comment            ':
                    'POST ' + this.baseUrl + '/comment body: {userId: string, content: string }',
